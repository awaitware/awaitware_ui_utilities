...
class AwPrefixExample extends StatelessWidget {
  ...
  Widget _buildHeader() {
    return aw.column(
      [
        aw.text('Using the "aw" Prefix')
            .text3Xl()
            .fontBold()
            .textGray900()
            .textCenter(),

        aw.text('More discoverable, easier to use!')
            .textLg()
            .textGray600()
            .textCenter()
            .pt2(),

        aw.text('Type "aw." to see all available helpers')
            .textSm()
            .textBlue600()
            .textCenter()
            .pt1(),
  ...
  Widget _buildTextExamples() {
    return aw.column(
      [
        ...
        aw.text('This is extra large text')
            .text4Xl()
            .fontBold()
            .textBlue600(),

        aw.text('This is large text')
            .text2Xl()
            .fontSemibold()
            .textGreen600(),

        aw.text('This is normal text with underline')
            .textBase()
            .underline()
            .textGray700(),

        aw.text('This is small italic text')
            .textSm()
            .italic()
            .textGray500(),
      ],
      crossAxisAlignment: CrossAxisAlignment.start,
    ).p4().bgWhite().roundedXl().shadowMd().m4();
  }
    ...
    return aw.card(
      ...
      child: aw.column(
        [
          ...
          aw.text('Created using aw.card() helper')
              .textBase()
              .textGray600()
              .textCenter(),
  ...
  Widget _buildLayoutExamples() {
    return aw.column(
      [
        ...
        aw.wrap(
          [
            aw.text('Tag 1').textXs().textBlue700().px3().py1().bgBlue100().roundedFull(),
            aw.text('Tag 2').textXs().textGreen700().px3().py1().bgGreen100().roundedFull(),
            aw.text('Tag 3').textXs().textOrange600().px3().py1().bgOrange100().roundedFull(),
            aw.text('Tag 4').textXs().textPurple600().px3().py1().bgPurple100().roundedFull(),
          ],
          spacing: 8,
          runSpacing: 8,
        ),
  ...
  Widget _buildSpacingExamples() {
    return aw.column(
      [
        ...
        aw.text('aw.spaceV(16) creates 16px vertical space').textSm().textGray600(),
        aw.spaceV(16),

        aw.text('aw.spaceH(16) creates 16px horizontal space').textSm().textGray600(),
