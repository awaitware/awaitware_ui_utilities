...
extension DecorationExtensions on Widget {
  ...
  Widget shadowSm() => Container(
        decoration: const BoxDecoration(
          boxShadow: [BoxShadow(color: Color(0x0D000000), offset: Offset(0, 1), blurRadius: 2)],
        ),
        child: this,
      );
  Widget shadow() => Container(
        decoration: const BoxDecoration(
          boxShadow: [BoxShadow(color: Color(0x1A000000), offset: Offset(0, 1), blurRadius: 3)],
        ),
        child: this,
      );
  Widget shadowMd() => Container(
        decoration: const BoxDecoration(
          boxShadow: [BoxShadow(color: Color(0x1A000000), offset: Offset(0, 4), blurRadius: 6, spreadRadius: -1)],
        ),
        child: this,
      );
  Widget shadowLg() => Container(
        decoration: const BoxDecoration(
          boxShadow: [BoxShadow(color: Color(0x1A000000), offset: Offset(0, 10), blurRadius: 15, spreadRadius: -3)],
        ),
        child: this,
      );
  Widget shadowXl() => Container(
        decoration: const BoxDecoration(
          boxShadow: [BoxShadow(color: Color(0x1A000000), offset: Offset(0, 20), blurRadius: 25, spreadRadius: -5)],
        ),
        child: this,
      );
